...
@interface AstuinfoController ()

@end

@implementation AstuinfoController
...
- (IBAction)saveclick:(id)sender {
    ...
    if ([self.delegate respondsToSelector:@selector(studentinfo:didSavestudentinfo:)])
    {
        ...
        self.student.passwdtmp = self.passwordfield.text;
